            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="d-flex justify-content-end">
                        <a href="{{ route('testimonial.create') }}" class="btn btn-primary"><i class="fa-solid fa-plus"></i> Add
                            New Testimonial</a>
                    </div>
                </div>
                <!-- Title End -->
                        ...
                        <table class="table table-striped" id="myTable">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Client degignation</th>
                            ...
                            <tbody>
                                @foreach ($testimonial as $key => $item)
                                    <tr>
                                        ...
                                        <td><img src="{{asset($item->client_image)}}" alt="" width="100"></td>
                                        <td>{{ $item->client_name }}</td>
                                        <td>{{ $item->client_designation }}</td>
                                        <td>
                                            <button class="btn btn-info"><i class="fa-solid fa-pen-to-square"></i> <a
                                                    href="{{ route('testimonial.edit', $item->client_name_slug) }}"
                                                    class="text-white">Edit</a></button>
                                            <form action="{{ route('testimonial.destroy', $item->client_name_slug) }}" method="post"
                                                id="deleteForm">
                                                @csrf
                                                @method('DELETE')
