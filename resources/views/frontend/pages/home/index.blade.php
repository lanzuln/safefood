...
@section('body')
                                        ...
                                        <div class="hero__slider--items">
                                            <div class="hero__slider--thumbnail">
                                                <img class="hero__slider--thumbnail__img display-block"
                                                    src="{{ asset($item->image ?? 'no-image.jpg') }}" alt="slider img">
                                            </div>
                                            <div class="slider__content text-center">
                                                ...
                                                <div
                                                    ...
                                                    <div class="bideo__play slider__play--bideo">
                                                        <a class="bideo__play--icon glightbox" href="{{ $item->v_url }}"
                                                            data-gallery="video">
    ...
    <section class="image__with--text__section section--padding">
            ...
            <div class="row row-cols-md-2 row-cols-1  align-items-center">
                <div class="col">
                    <div class="image__with--text__thumbnail">
                        <img class="display-block" src="{{ asset('frontend/assets/img/other/drone-image.webp') }}"
                            alt="drone-image">
                    </div>
                </div>
                <div class="col">
                    <div class="image__with--text__content">
                        ...
                        <div class="image__with--text__content--footer d-flex">
                            <img class="display-block" src="{{ asset('frontend/assets/img/other/text-shape.webp') }}"
                                alt="text-shape">
        ...
        <img class="image__with--text__position--shape display-block"
            src="{{ asset('frontend/assets/img/other/image-with-text-section-shape.webp') }}" alt="shape img">
    </section>
            ...
            <div class="row row-cols-lg-2 row-cols-md-2 row-cols-1 align-items-center">
                <div class="col">
                    <div class="about__content">
                        ...
                        <div class="about__content--step mb-25">
                            <p class="about__content--desc mb-20">Beyond more stoic this along goodness this sed wow manatee
                                mongos
                                flusterd impressive man farcrud opened inside owin punitively
                                wasteful telling spransac coldly spokeles.</p>
                            <ul class="mb-20">
                        ...
                        <div class="about__content--author d-flex align-items-center mb-50">
                            <div class="about__content--author__thumb">
                                <img class="display-block" src="{{ asset('frontend/assets/img/other/about-author.webp') }}"
                            ...
                            <div class="about__content--author__text d-flex align-items-center">
                                ...
                                <img class="about__author--signature display-block"
                                    src="{{ asset('frontend/assets/img/icon/signature.webp') }}" alt="signature">
                            </div>
                        </div>
                ...
                <div class="col">
                    <div class="about__thumbnail">
                        <img class="display-block" src="{{ asset('frontend/assets/img/other/about-thumb.webp') }}"
                            alt="about-thumb">
                    </div>
                </div>
            </div>
    ...
    @include('frontend.component.feature_product')
    <!-- End product details section -->

    <!-- Start banner section -->
    <div class="banner__video--section banner__section--bg position__relative section--padding">
        <img class="drone__position--img display-block"
            src="{{ asset('frontend/assets/img/other/drone-position-img.webp') }}" alt="drone-position-img">
        <div class="container">
                ...
                <div class="row row-cols-md-3 row-cols-sm-2 row-cols-2 mb--n30">
                        ...
                        <article class="team__card">
                            <div class="team__card--thumbnail">
                                <img class="team__card--thumbnail__img display-block"
                                    src="{{ asset('frontend/assets/img/other/team1.webp') }}" alt="team-thumb">
                            </div>
                    ...
                    <div class="col custom-col mb-30">
                        <article class="team__card">
                            <div class="team__card--thumbnail">
                                <img class="team__card--thumbnail__img display-block"
                                    src="{{ asset('frontend/assets/img/other/team2.webp') }}" alt="team-thumb">
                            </div>
                            <div class="team__card--content ">
                    ...
                    <div class="col custom-col mb-30">
                        <article class="team__card">
                            <div class="team__card--thumbnail">
                                <img class="team__card--thumbnail__img display-block"
                                    src="{{ asset('frontend/assets/img/other/team3.webp') }}" alt="team-thumb">
                            </div>
                            <div class="team__card--content ">
                                    ...
                                    <a class="project__card--link" href="shop.html">
                                        <div class="project__card--thumbnail">
                                            <img class="project__card--thumbnail__img display-block"
                                                src="{{ asset('frontend/assets/img/product/product1.webp') }}"
                                                alt="product-img">
                                        </div>
                                        <div
                            ...
                            <div class="col custom-col-2 mb-30">
                                <article class="project__card ">
                                    <a class="project__card--link" href="shop.html">
                                        <div class="project__card--thumbnail">
                                            <img class="project__card--thumbnail__img display-block"
                                                src="{{ asset('frontend/assets/img/product/product2.webp') }}"
                                                alt="product-img">
                                        </div>
                                        <div
                                            class="project__card--content d-flex justify-content-between align-items-center">
                            ...
                            <div class="col custom-col-2 mb-30">
                                <article class="project__card ">
                                    <a class="project__card--link" href="shop.html">
                                        <div class="project__card--thumbnail">
                                            <img class="project__card--thumbnail__img display-block"
                                                src="{{ asset('frontend/assets/img/product/product3.webp') }}"
                                                alt="product-img">
                                        </div>
                                        <div
                                            class="project__card--content d-flex justify-content-between align-items-center">
                            ...
                            <div class="col custom-col-2 mb-30">
                                <article class="project__card ">
                                    <a class="project__card--link" href="shop.html">
                                        <div class="project__card--thumbnail">
                                            <img class="project__card--thumbnail__img display-block"
                                                src="{{ asset('frontend/assets/img/product/product4.webp') }}"
                                                alt="product-img">
                                        </div>
                                        <div
                                            class="project__card--content d-flex justify-content-between align-items-center">
                            ...
                            <div class="col custom-col-2 mb-30">
                                <article class="project__card ">
                                    <a class="project__card--link" href="shop.html">
                                        <div class="project__card--thumbnail">
                                            <img class="project__card--thumbnail__img display-block"
                                                src="{{ asset('frontend/assets/img/product/product5.webp') }}"
                                                alt="product-img">
                                        </div>
                                        <div
                                            class="project__card--content d-flex justify-content-between align-items-center">
                            ...
                            <div class="col custom-col-2 mb-30">
                                <article class="project__card ">
                                    <a class="project__card--link" href="shop.html">
                                        <div class="project__card--thumbnail">
                                            <img class="project__card--thumbnail__img display-block"
                                                src="{{ asset('frontend/assets/img/product/product6.webp') }}"
                                                alt="product-img">
                                        </div>
                                        <div
                                            class="project__card--content d-flex justify-content-between align-items-center">
                        ...
                        <article class="blog__card">
                            <div class="blog__card--thumbnail">
                                <a class="blog__card--thumbnail__link display-block" href="blog-details.html"><img
                                        ...
                                        src="{{ asset('frontend/assets/img/blog/blog1.webp') }}" alt="blog-img"></a>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <article class="blog__card">
                            <div class="blog__card--thumbnail">
                                <a class="blog__card--thumbnail__link display-block" href="blog-details.html"><img
                                        class="blog__card--thumbnail__img display-block"
                                        src="{{ asset('frontend/assets/img/blog/blog2.webp') }}" alt="blog-img"></a>
                            </div>
                            <div class="blog__card--content">
                                <ul class="blog__card--meta d-flex justify-content-center">
                                    <li class="blog__card--meta__text text__secondary">
                                ...
                                <h3 class="blog__card--title"><a href="blog-details.html"> Amet This is adipisicing
                                        elit. Error, nons. </a></h3>
                                <a class="blog__card--btn primary__btn" href="blog-details.html">Read More </a>
                            </div>
                        </article>
                    </div>
                    <div class="swiper-slide">
                        <article class="blog__card">
                            <div class="blog__card--thumbnail">
                                <a class="blog__card--thumbnail__link display-block" href="blog-details.html"><img
                                        class="blog__card--thumbnail__img display-block"
                                        src="{{ asset('frontend/assets/img/blog/blog3.webp') }}" alt="blog-img"></a>
                            </div>
                            <div class="blog__card--content">
                                <ul class="blog__card--meta d-flex justify-content-center">
                                    <li class="blog__card--meta__text text__secondary">
                                ...
                                <h3 class="blog__card--title"><a href="blog-details.html">Lorem ipsum dolor sit amet,
                                        are adipisicing elit. </a></h3>
                                <a class="blog__card--btn primary__btn" href="blog-details.html">Read More </a>
                            </div>
                        </article>
                    </div>
