                            ...
                            <a class="services__card--link" href="product-details.html">
                                <div class="services__card--topbar d-flex justify-content-between">
                                    <div class="services__card--icon mb-20">
                                        <img class="display-block services__card--primary__icon" src="{{asset('frontend/assets/img/icon/service-icon1.webp')}}" alt="services-icon">
                    ...
                    <div class="col custom-col mb-30">
                        <article class="services__card">
                            <a class="services__card--link" href="product-details.html">
                                <div class="services__card--topbar d-flex justify-content-between">
                                    <div class="services__card--icon mb-20">
                                        <img class="display-block services__card--primary__icon" src="{{asset('frontend/assets/img/icon/service-icon2.webp')}}" alt="services-icon">
                                        <img class="display-block services__card--secondary__icon" src="{{asset('frontend/assets/img/icon/service-icon2-white.webp')}}" alt="services-icon">
                                    </div>
                                    <div class="services__card--number">
                    ...
                    <div class="col custom-col mb-30">
                        <article class="services__card">
                            <a class="services__card--link" href="shop.html">
                                <div class="services__card--topbar d-flex justify-content-between">
                                    <div class="services__card--icon mb-20">
                                        <img class="display-block services__card--primary__icon" src="{{asset('frontend/assets/img/icon/service-icon3.webp')}}" alt="services-icon">
                                        <img class="display-block services__card--secondary__icon" src="{{asset('frontend/assets/img/icon/service-icon3-white.webp')}}" alt="services-icon">
                                    </div>
                                    <div class="services__card--number">
                    ...
                    <div class="col custom-col mb-30">
                        <article class="services__card">
                            <a class="services__card--link" href="shop.html">
                                <div class="services__card--topbar d-flex justify-content-between">
                                    <div class="services__card--icon mb-20">
                                        <img class="display-block services__card--primary__icon" src="{{asset('frontend/assets/img/icon/service-icon4.webp')}}" alt="services-icon">
                                        <img class="display-block services__card--secondary__icon" src="{{asset('frontend/assets/img/icon/service-icon4-white.webp')}}" alt="services-icon">
                                    </div>
                                    <div class="services__card--number">
                    ...
                    <div class="col custom-col mb-30">
                        <article class="services__card">
                            <a class="services__card--link" href="shop.html">
                                <div class="services__card--topbar d-flex justify-content-between">
                                    <div class="services__card--icon mb-20">
                                        <img class="display-block services__card--primary__icon" src="{{asset('frontend/assets/img/icon/service-icon5.webp')}}" alt="services-icon">
                                        <img class="display-block services__card--secondary__icon" src="{{asset('frontend/assets/img/icon/service-icon5-white.webp')}}" alt="services-icon">
                                    </div>
                                    <div class="services__card--number">
                    ...
                    <div class="col custom-col mb-30">
                        <article class="services__card">
                            <a class="services__card--link" href="shop.html">
                                <div class="services__card--topbar d-flex justify-content-between">
                                    <div class="services__card--icon mb-20">
                                        <img class="display-block services__card--primary__icon" src="{{asset('frontend/assets/img/icon/service-icon6.webp')}}" alt="services-icon">
                                        <img class="display-block services__card--secondary__icon" src="{{asset('frontend/assets/img/icon/service-icon6-white.webp')}}" alt="services-icon">
                                    </div>
                                    <div class="services__card--number">
