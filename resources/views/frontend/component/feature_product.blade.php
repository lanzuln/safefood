<section class="product__details--section section--padding">
    <div class="container">
        <div class="section__heading text-center mb-50">
            <h2 class="section__heading--maintitle text__secondary mb-10">Best Selling</h2>
            ...
            <div class="row row-cols-lg-2 row-cols-md-2">
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="product__media--nav__items">
                                        <img class="product__media--nav__items--img"
                                            src="{{ asset($hit_product->image) }}" alt="product-nav-img">
                                    </div>
                                </div>
                                @foreach ($multi_image as $item)
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img"
                                                src="{{ asset($item->multi_image) }}" alt="product-nav-img">
                                        </div>
                                    </div>
                                @endforeach
                                        ...
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link"
                                                href="javascript:void(0)"><img
                                                    ...
                                                    src="{{ asset($hit_product->image) }}" alt="product-media-img"></a>
                ...
                <div class="col">
                    <div class="product__details--info">
                        <form action="#">
                            <h3 class="product__details--info__title mb-15">{{ $hit_product->name }}</h3>
                            ...
                            <div class="product__details--info__price mb-10">
                                {{-- @php
                                    $hit_product-
                                @endphp --}}
                                @if ($hit_product->sale_price == null)
                                    <span class="current__price">${{$hit_product->real_price}}</span>
                                @else
                                <span class="current__price">${{$hit_product->sale_price}}</span>
                                <span class="old__price">${{$hit_product->real_price}}</span>
                                @endif
                            </div>
                                ...
                                <div class="product__variant--list mb-15">
                                    <div class="product__details--info__meta">
                                        <p class="product__details--info__meta--list"><strong>Category:</strong>
                                            <span>{{$hit_product->category->name}}</span> </p>
                                    </div>
                                </div>
                            </div>
